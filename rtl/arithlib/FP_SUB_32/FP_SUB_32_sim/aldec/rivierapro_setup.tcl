...
# ----------------------------------------
# If FP_SUB_32 is one of several IP cores in your
...
alias com {
  ...
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FP_SUB_32.vhd"            
}
